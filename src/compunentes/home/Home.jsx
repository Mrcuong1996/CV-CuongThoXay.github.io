    ...
    <div className="container">
      <div className="personal__infor">
        <div className="avatar">
          ...
          <p className="tex-avt-check">FrontEnd  
      ...
      <Card  size="small">
          <p>
             <Avatar src={process.env.PUBLIC_URL + `/Imgs/userName.JPG`}  className="contact__info-icon-avt" />
      ...
      <Card  size="small">
          <p>
            <a href="https://www.facebook.com/MrCuong1996/"><FacebookOutlined className="info-icon" />
             Facebook.com/Mrcuong1996</a>
          </p>
      </Card>
      </Badge.Ribbon>
      ...
      <Card  size="small">
          <p>
             <Avatar src="https://icon-library.com/images/git-hub-icon/git-hub-icon-18.jpg" 
              className="info-icon avt-github" />
            <a href="https://github.com/Mrcuong1996">GitHub.com/Mrcuong1996</a>
          </p>
      </Card>
      </Badge.Ribbon> */}
      ...
      <div className="skills-portfolio-about">
        <div className="about">
          ...
          <p>
            • Đã đươc đào tạo, hướng dẫn các kiến thức chuyên môn FrontEnd và kĩ năng làm việc trong 3 tháng tại <a href="https://www.nodemy.vn/">Nodemy</a>.
          </p>
          <p>
            • Đã được tham gia phát triển sản phẩm, dự án theo quy trình chuẩn của công ty từ thiết kế, code, test...
          </p>
          <p>
             • Sẵn sàng học hỏi công nghệ mới. Có khả năng giao tiếp tốt và tư duy sáng tạo cao, giải quyết vấn đề nhanh gọn.
          </p>
          <p>
             • Cẩn thận, tỉ mỉ, trung thực, có trách nhiệm cao với công việc.
          </p>
          <p>• Nhiệt huyết, biết lắng nghe, chịu được áp lực công việc.</p>
          <p>• Thích nghi nhanh với sự thay đổi liên tục của mô hình hệ thống.
          </p>
